...
int storage_dir_save_string_to_file(storage_dir_t *d,
                                    ...
                                    int binary,
                                    char **fname_out);
int storage_dir_save_labelled_to_file(storage_dir_t *d,
                                      const struct config_line_t *labels,
                                      const uint8_t *data,
                                      size_t length,
                                      char **fname_out);
tor_mmap_t *storage_dir_map_labelled(storage_dir_t *dir,
                                     const char *fname,
                                     struct config_line_t **labels_out,
                                     const uint8_t **data_out,
                                     size_t *size_out);
uint8_t *storage_dir_read_labelled(storage_dir_t *d, const char *fname,
                                   struct config_line_t **labels_out,
                                   size_t *sz_out);
